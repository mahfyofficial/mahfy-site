...
window.MAHFY_PRODUCTS = [
  ...
  },
  {
    ...
    grade: "8 mm",
    origin: "Kerala",
    description: "Extra-bold green cardamom from Kerala, graded at 8 mm. Chosen when you want large, well-filled pods for gifting, display and special cooking. A premium cardamom online India pick for kitchens that want the largest listed size.",
  ...
  },
  {
    ...
    grade: "Whole",
    origin: "Kerala",
    description: "Buy black pepper from Kerala for daily cooking — whole Malabar peppercorns with sharp heat and a clean, familiar aroma.",
  ...
  },
  {
    ...
    grade: "Whole bean",
    origin: "Kerala",
    description: "Kerala coffee online as whole Arabica beans. Roast and grind notes may vary by lot — ask us if you need a specific profile.",
